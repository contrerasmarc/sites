...
Sites.GeneralDescriptionView = SC.SplitView.extend({
  ...
  leftView: SC.View.design(SC.SplitChild, {
    ...
    colSite: SC.View.extend({
      ...
      childViews: ['lblName', 'txtName', 'lblZone', 'cbxZone', 'lblCountry', 'cbxCountry', 'lblState', 'txtState', 'lblGroup', 'txtGroup', 'lblRefSite', 'radRefSite', 'lblTown', 'txtTown', 'lblAltitude', 'txtAltitude'],
  ...
  middleView: SC.View.design(SC.SplitChild, {
    ...
    colOperation: SC.View.extend({
      ...
      childViewLayout: SC.View.VERTICAL_STACK,
      childViewLayoutOptions: Sites.LAYOUT_VERTICAL,
      childViews: ['lblActivity', 'cbxActivity', 'lblMaterial', 'lblMaterial2ndLine', 'cbxMaterial', 'lblMethod', 'cbxMethod', 'lblProduction', 'txtProduction'],
